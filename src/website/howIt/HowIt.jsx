      ...
      <AnimatedComponent yOffset={50} delay={0}>
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center" }}>
            <TitleSection
              subheading={"Simple Process No Technical Knowledge Required"}
              heading={"How WASenderAPI"}
              highlight={"Works for You"}
              description={
                "Get Started With WASenderApi Im Minutes With Our Simple, 3-Step Process"
              }
