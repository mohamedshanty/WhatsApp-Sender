        ...
        >
          ...
          <Stack spacing={3} flex={1}>
            ...
            <Typography
              variant="body1"
              color="#ccc"
              sx={{ maxWidth: "600px", fontSize: { xs: "0.9rem", sm: "1rem" } }}
            >
              WasenderAPI is a fast, affordable WhatsApp API for developers.
              Manage multiple sessions, and scale without per-message fees. Try
              it free today!
            </Typography>
            <Stack spacing={2}>
